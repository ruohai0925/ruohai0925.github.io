---
layout: default
title: "The Second Half of Computational Fluid Dynamics: Education and Industrial Application"
date: 2026-02-17
author: ZDSJTU
---

# The Second Half of Computational Fluid Dynamics
...
In April 2025, Shunyu Yao, then a researcher at OpenAI, published an article titled "The Second Half." [1] Now, on February 17, 2026—approximately a year and a half later—I have profoundly felt the potential and massive impact of AI on my industry, Computational Fluid Dynamics (CFD). This realization compelled me to write this article.

I believe the development of AI has never been linear. When Shunyu wrote "The Second Half," AI's capabilities might have primarily influenced the field of computer science. However, after a year of accumulation and radiation, I believe it has now arrived at the doorstep of my industry. If you find this article too long, here is the core conclusion upfront: AI will reshape the education and various industrial applications of Computational Fluid Dynamics, from code development to human-computer interaction.

Recording this moment has special significance. First, while driving for groceries or commuting, I utilized fragmented time to listen to a recent three-hour interview with Shunyu [2]. Furthermore, just the week before last, on February 5, 2026, Anthropic released its new model, Claude Opus 4.6. I used it to solve a thorny problem at work and deeply felt its power. I couldn't wait to share this feeling with everyone. Unfortunately, as it coincides with the Chinese Lunar New Year, most people are enjoying reunions, and few are inclined to discuss such serious topics during the holidays. Thus, I write these words as a review of my old year and a revelation for the new one.
...
Driven by research and application needs, CFD emerged in the 1930s and 40s [3]. Through the continuous exploration of numerical schemes by groups of mathematicians and physicists, they solidified the classic and fundamental methods we use in the solving domain today (such as the numerical solution of Navier-Stokes equations) to explain and predict natural phenomena. For example, we can use CFD to calculate the aerodynamic performance of an F1 race car or to explain why airplanes can fly.

Based on the sedimentation of this knowledge, major companies have mastered their own commercial products, such as FLUENT [4], STAR-CCM+ [5], and Fidelity [6]. These products help customers perform simulations before manufacturing real objects, thereby saving costs and providing optimization solutions. Of course, open-source software like OpenFOAM [7], SU2 [8], and FEniCS [9] has also supplemented this community.
...
Yao, Shunyu. "The Second Half." April 10, 2025. https://ysymyth.github.io/The-Second-Half/

https://www.youtube.com/watch?v=gQgKkUsx5q0
...
https://www.cadence.com/en_US/home/tools/system-analysis/computational-fluid-dynamics.html
...
Data regarding "70-80% of time coding with AI" is not an official statistic but aligns with internal discussions from OpenAI and Anthropic regarding the penetration rate of "AI-assisted coding" (e.g., Andrej Karpathy and others have mentioned the current paradigm shift in programming).
